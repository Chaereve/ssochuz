...
const files = [path.join('..', 'tools', 'check_src.js'), path.join('..', 'tools', 'check_secrets.js'), 't_worker.mjs', 't_config.js', 't_html.js', 't_follow.js', 't_pwa.js', 't_preload.js', 't_view.js', 't_home.js', 't_mobile.js', 't_stats.js', 't_story.js', 't_reader.js', 't_flows.js', 't_doctor.js', 't_sweep.js', 'cf_admin_test.js'];
let bad = 0;
