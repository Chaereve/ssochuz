/* Chạy toàn bộ kiểm thử giao diện (jsdom).
   ...
   Mỗi bài in ra JSON; mọi khoá "errors*" phải là [] thì mới coi là đạt.
     ...
     t_wordstudio.js   phòng soạn kiểu Word (ribbon, tìm/thay, zoom, lọc/nhảy chương, dán sạch, xuất file)
