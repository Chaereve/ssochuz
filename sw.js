...
var PRECACHE = [
  ...
  '/my-space',
  '/profile',
  '/cz-space.js?v=20260917d',
  '/manifest.webmanifest',
  '/cz.css?v=20260917d',
  '/cz-app.js?v=20260917d',
  '/cz-home.js?v=20260917d',
  '/cz-story.js?v=20260917d',
  '/cz-people.js?v=20260917d',
  '/cz-config.js?v=20260917d',
  '/cz-auth.js?v=20260917d',
  '/ssochuz.png?v=1'
];
